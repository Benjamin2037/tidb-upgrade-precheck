// Package kbgenerator provides knowledge base generation and loading functionality
package kbgenerator
...
func LoadKnowledgeBase(knowledgeBasePath, version string) (map[string]interface{}, error) {
	...
	for _, component := range components {
		...
		// Load upgrade_logic.json (component-specific)
...
// Input version is always a full three-digit version (e.g., v7.5.1, v6.5.0, v7.1.2)
// Example: v7.5.1 -> v7.5, v6.5.0 -> v6.5, v7.1.2 -> v7.1
