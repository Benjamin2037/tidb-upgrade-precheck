...
// If version is specified (e.g., "v7.5.0"), returns version-specific file paths
...
// parseVersionTag parses version tag (e.g., "v7.5.0") into major and minor version numbers
