...
import (
	...
	"github.com/pingcap/tidb-upgrade-precheck/pkg/collector/runtime/pd"
	"github.com/pingcap/tidb-upgrade-precheck/pkg/collector/runtime/tidb"
	"github.com/pingcap/tidb-upgrade-precheck/pkg/collector/runtime/tiflash"
	"github.com/pingcap/tidb-upgrade-precheck/pkg/collector/runtime/tikv"
)
...
func (c *Collector) Collect(endpoints collector.ClusterEndpoints, req *CollectDataRequirements) (*collector.ClusterSnapshot, error) {
...
func (c *Collector) collectWithRequirements(endpoints collector.ClusterEndpoints, req CollectDataRequirements) (*collector.ClusterSnapshot, error) {
