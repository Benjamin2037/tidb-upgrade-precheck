...
func (c *tiflashCollector) Collect(addrs []string) ([]collector.ComponentState, error) {
...
func (c *tiflashCollector) collectFromInstance(addr string) (*collector.ComponentState, error) {
	state := &collector.ComponentState{
		Type:      collector.TiFlashComponent,
