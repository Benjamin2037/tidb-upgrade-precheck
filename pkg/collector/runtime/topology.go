...
func LoadTopologyFromFile(topologyPath string) (*collector.ClusterEndpoints, error) {
...
func LoadTopologyFromYAML(yamlContent string) (*collector.ClusterEndpoints, error) {
	var topo Topology
...
func ParseTopologyEndpointString(endpointStr string) (*collector.ClusterEndpoints, error) {
	if endpointStr == "" {
