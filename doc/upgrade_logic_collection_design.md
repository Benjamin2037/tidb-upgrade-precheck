...
For information about parameter collection (tracking default values of TiDB system variables across versions), please refer to the [Parameter Collection Design](./parameter_collection_design.md) document.